...
<div class="resume">
    ...
    <h1 class="page-title">Resumo do {{ $firm->manufacture }} {{ $firm->model }}{{ $firm->version}}</h1>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="col-xs-12 col-sm-4">
              <figure>
                <img class="img-circle img-responsive img-thumbnail" alt="" src="{{url("logos/{$firm->logo}")}}">
              </figure>
            ...
            <div class="col-xs-12 col-sm-8">
              <ul class="list-group">
                <li class="list-group-item">{{ $firm->manufacture }}</li>
                <li class="list-group-item">{{ $firm->model}}</li>
                <li class="list-group-item">{{ $firm->version }}</li>
